...
void main() {
  ...
  group('Flashcard → Review Journey Tests', () {
    ...
    testWidgets('AS a student, I WANT words I know to NOT appear in review SO THAT I focus on difficult words', (tester) async {
      // GIVEN: I launch the app
      app.main();
      await TestHelpers.waitForAppLoad(tester);
    ...
    testWidgets('AS a student, I WANT multiple difficult words to accumulate in review SO THAT I can review them together', (tester) async {
      // GIVEN: I launch the app
      app.main();
      await TestHelpers.waitForAppLoad(tester);
    ...
    testWidgets('AS a student, I WANT to complete reviews with different difficulties SO THAT words are rescheduled appropriately', (tester) async {
    ...
    testWidgets('AS a student, I WANT my review progress to persist across navigation SO THAT I can switch between features', (tester) async {
    ...
    testWidgets('AS a student, I WANT to see helpful guidance when my review queue is empty SO THAT I know how to add words', (tester) async {
    ...
    testWidgets('AS a student, I WANT to flip flashcards before marking them SO THAT I can see both sides', (tester) async {
      // GIVEN: I launch the app
      app.main();
      await TestHelpers.waitForAppLoad(tester);
    ...
    testWidgets('AS a student, I WANT consistent behavior when rapidly swiping SO THAT the app remains responsive', (tester) async {
      // GIVEN: I launch the app
      app.main();
      await TestHelpers.waitForAppLoad(tester);
