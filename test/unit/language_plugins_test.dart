...
void main() {
  group('LatinPlugin', () {
    ...
    test('has correct language metadata', () {
      ...
      expect(
        ...
        equals('Classical Latin for academic study'),
      );
    });
    ...
    test('formats example with classical style', () {
      ...
      expect(
        formattedExample,
        equals('Veritas vos liberabit — "The truth will set you free"'),
      );
    });
    ...
    test('provides learning tips', () {
      ...
      expect(
        tips,
        contains(matches(RegExp(r'case endings', caseSensitive: false))),
      );
      expect(
        tips,
        contains(matches(RegExp(r'verb conjugation', caseSensitive: false))),
      );
    });
    ...
    test('generates correct asset path', () {
      ...
      final path = plugin.getVocabularyAssetPath(
  ...
  group('SpanishPlugin', () {
    ...
    test('formats example with modern style', () {
      ...
      expect(
        formattedExample,
        equals('"Hola, ¿cómo estás?" → "Hello, how are you?"'),
      );
    });
    ...
    test('provides learning tips', () {
      ...
      expect(
        tips,
        contains(
          matches(RegExp(r'masculine and feminine', caseSensitive: false)),
        ),
      );
      expect(
        tips,
        contains(matches(RegExp(r'verb conjugations', caseSensitive: false))),
      );
    });
  ...
  group('Plugin Comparison', () {
    test('plugins have different language codes', () {
      ...
      expect(
        latinPlugin.language.code,
        isNot(equals(spanishPlugin.language.code)),
      );
      expect(
        latinPlugin.language.name,
        isNot(equals(spanishPlugin.language.name)),
      );
    });
