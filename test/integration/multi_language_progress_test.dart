...
void main() {
  group('Multi-Language Progress Integration Tests', () {
    ...
    test('manages studying languages list correctly', () async {
      ...
      expect(
        studyingLanguages.isNotEmpty,
        isTrue,
        reason: 'Should have at least default language',
      );
    ...
    test('tracks progress separately for each language', () async {
      ...
      expect(
        latinKnown.contains('agua'),
        isFalse,
      ); // Spanish word shouldn't be in Latin
      expect(spanishKnown.contains('agua'), isTrue);
      expect(
        spanishKnown.contains('aqua'),
        isFalse,
      ); // Latin word shouldn't be in Spanish
    });
    ...
    test('data reset clears all language data', () async {
      ...
      expect(
        dataService.getDifficultWordsForLanguage('spanish').isNotEmpty,
        isTrue,
      );
      ...
      expect(
        dataService.getDifficultWordsForLanguage('spanish').isEmpty,
        isTrue,
      );
    ...
    test('handles edge cases gracefully', () {
      ...
      final nonExistentStats = dataService.getLearningStatsForLanguage(
        'nonexistent',
      );
