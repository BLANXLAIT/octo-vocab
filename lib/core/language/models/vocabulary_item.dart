...
class VocabularyItem {
  ...
  factory VocabularyItem.fromJson(Map<String, dynamic> json) {
    return VocabularyItem(
      id: (json['id'] ?? json['term'] ?? json['latin'] ?? '').toString(),
      term: (json['term'] ?? json['latin'] ?? '').toString(),
      translation: (json['translation'] ?? json['english'] ?? '').toString(),
      partOfSpeech: json['partOfSpeech'] as String? ?? json['pos'] as String?,
      exampleTerm: json['exampleTerm'] as String? ?? json['exampleLatin'] as String?,
      exampleTranslation: json['exampleTranslation'] as String? ?? json['exampleEnglish'] as String?,
      tags: (json['tags'] as List<dynamic>? ?? [])
          .map((e) => e.toString())
          .toList(),
      extras: Map<String, dynamic>.from(json)
        ..removeWhere((key, _) => [
          'id', 'term', 'latin', 'translation', 'english', 
          'partOfSpeech', 'pos', 'exampleTerm', 'exampleLatin',
          'exampleTranslation', 'exampleEnglish', 'tags'
        ].contains(key)),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (exampleTranslation != null) json['exampleTranslation'] = exampleTranslation;
  ...
  @override
  String toString() => 'VocabularyItem(id: $id, term: $term, translation: $translation)';
